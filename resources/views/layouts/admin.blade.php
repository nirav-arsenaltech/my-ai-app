    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div class="brand-text">
                <a href="{{ route('welcome') }}"><span class="brand-name">{{ config('app.name') }}</span></a>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('notes.index') }}"
               class="nav-item {{ request()->routeIs('notes.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="17" width="17" stroke-width="1.5" stroke="currentColor">
            ...
            @if (Auth::check() && Auth::user()->is_admin)
                ...
                <a href="{{ route('admin.users.index') }}" class="nav-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="17" height="17" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <a href="" class="pointer-events-none opacity-50 nav-item {{ request()->routeIs('admin.configuration*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg"  width="17" height="17"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
